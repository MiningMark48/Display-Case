...
import com.miningmark48.displaycase.container.slot.SlotArmor;
...
public class ContainerDCSingleSlotArmor extends Container {
    ...
    public ContainerDCSingleSlotArmor(final IInventory playerInv, TileEntityDisplayCaseBase te){
        this.te = te;

        //Tile Entity
        this.addSlotToContainer(new SlotArmor(te, 0, 7, 7));
